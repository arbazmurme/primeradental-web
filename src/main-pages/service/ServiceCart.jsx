        ...
        <>
            ...
            <div style={{ overflow: "hidden" }}>
                ...
                <section className="user-dashboard-section section-b-space">
                    <div className="">
                        <div className="row">
                            <div className="col-xxl-6 col-lg-6" style={{ boxShadow: "inherit" }}>
                                                            ...
                                                            <tbody>
                                                                <tr className="product-box-contain">
                                                                    <td className="product-detail">
                                                                        <div className="product border-0">
                                                                            ...
                                                                            <div className="product-detail">
                                                                                <ul>
                                                                                    <li className="name">
                                                                                        <a href="product-left-thumbnail.html">Waldent Straight</a>
                                                                                    </li>

                                                                                    <li className="text-content"><span className="text-title">Quantity</span> - 1 PCS</li>
                                                                                    <li>
                                                                                        <h5 className="text-content d-inline-block"><b>Price: ₹xxxxx </b></h5>
                                                                                        {/* <span>₹35.10</span> */}
                                                                    ...
                                                                    <div className="note-box product-package">
                                                                        ...
                                                                        <div style={{ marginLeft: "60px", marginTop: "20px", color: "red", textDecoration: "underline" }} className="">Remove</div>
                                            ...
                                            <div className="col-xxl-3">
                                                <div className="summery-box p-sticky">
                                                    <div className="summery-header">
                                                        <h3 style={{ fontSize: "26px" }}>Services Cart</h3>
                                                    </div>
                                                    <div className="summery-contain">
                                                        <ul>
                                                            ...
                                                            <li className="align-items-start">
                                                                ...
                                                                <Link href="/coupon">
                                                                    <div style={{ marginLeft: "445px", color: "rgb(13, 164, 135)", textDecoration: "underline" }} > <b>Apply</b> </div>
                                                                </Link>
                                                            </li>
                                                            <li className="align-items-start">
                                                                <h4>Wallet Used</h4>
                                                    ...
                                                    <div className="button-group cart-button">
                                                        <ul>
                                                            <Link href="/checkout">
                                                                <li>
                                                                    <button onclick="location.to = 'checkout.html';" className="btn btn-animation proceed-btn fw-bold">Checkout</button>
                                                                </li>
                                                            </Link>
                                                        </ul>
                                                    </div>

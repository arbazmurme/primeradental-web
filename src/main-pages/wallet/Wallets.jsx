          ...
          <div className="row">
                  ...
                  <li className="nav-item" role="presentation">
                    <Link href="/downloads">
                      <button
                        ...
                        role="tab"
                      >
                        <i data-feather="credit-card" /> Downloads
                      </button>
                    </Link>
                  </li>
                  <li className="nav-item" role="presentation">
            ...
            <div className="col-xxl-9 col-lg-8 ">
              ...
              >
                ...
                <Dropdown.Item href="//address">Addresses</Dropdown.Item>
                    ...
                    <div className="dashboard-home">
                      ...
                      <div className="total-box">
                        <div className="row g-sm-4 g-3">
                          ...
                          <div className="col-xxl-12 col-lg-12 col-md-12 col-sm-12">
                            <div className="total-contain">
                              {/* <img src="https://themes.pixelstrap.com/fastkart/assets/images/svg/pending.svg" className="img-1 blur-up lazyload" alt="dummy" />
                                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/svg/pending.svg" className="blur-up lazyload" alt="dummy" /> */}
                              <FiAlertCircle
                                style={{ fontSize: "30px", color: "#2ec2c6" }}
                              />
                              <div className="total-detail">
                                <h5>
                                  <b>Free Cash Expired</b>
                                </h5>
                                <p>Expires 08/12/2024</p>
                                <h3>₹75</h3>
                              </div>
                            </div>
                          </div>
                          {/* <div className="col-xxl-4 col-lg-6 col-md-4 col-sm-6">
                                                        <div className="total-contain">
                                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/svg/wishlist.svg" className="img-1 blur-up lazyload" alt="dummy" />
                                                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/svg/wishlist.svg" className="blur-up lazyload" alt="dummy" />
                                                            <div className="total-detail">
                                                                <h5>Store Credits</h5>
                                                                <h3>32158</h3>
                                                            </div>

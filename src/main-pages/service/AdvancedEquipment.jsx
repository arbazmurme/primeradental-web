...
import SliderAdvancedEquipment from '@/components/sliderservice/SliderAdvancedEquipment';
                            ...
                            <div className="breadcrumb-contain">
                                ...
                                <nav>
                                    <ol className="breadcrumb mb-0">
                                        ...
                                        <li className="breadcrumb-item active">Advanced Equipment </li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
